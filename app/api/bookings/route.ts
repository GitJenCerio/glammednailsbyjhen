...
export async function POST(request: Request) {
  ...
  const { slotId, serviceType, pairedSlotId, linkedSlotIds, clientType, repeatClientEmail, serviceLocation } = body ?? {};
  ...
  try {
    const result = await createBooking(slotId, { serviceType, pairedSlotId, linkedSlotIds, clientType, repeatClientEmail, serviceLocation });
